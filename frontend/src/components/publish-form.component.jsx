...
const PublishForm = () => {
  ...
  const publishBlog = (e) => {
    ...
    if (!title.length) {
      return toast.error("Write blog title first");
    }

    if (!description.length || description.length > 200) {
      return toast.error("Write short description");
    }

    if (!tags.length) {
      return toast.error("Add tags first");
    }
  ...
  return (
    <AnimationWrapper>
      <section className="w-screen min-h-screen grid items-center lg:grid-cols-2 py-16 lg:gap-4">
        ...
        <button
          className="w-12 h-12 absolute right-[5vw] z-10 top-[2%] lg:top-[4%]"
        ...
        <div className="border-grey lg:border-1 lg:pl-8">
          ...
          <p className="text-dark-grey mb-2 mt-9">
            Topics - (Helps in searching and ranking of your blog post)
          </p>
